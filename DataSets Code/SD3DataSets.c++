...
int main() {
    // Generate SD-3 dataset
    int numActivities = 500;  // Large-scale dataset
    int numParticipants = 15; // 15 participants
    int maxStartTime = 100;   // Larger time horizon
    int maxDuration = 20;     // Longer activities
    int maxWeight = 200;      // Higher weight range
    int maxCpu = 15;         // Higher resource capacity
    int maxMemory = 15;      // Higher resource capacity
